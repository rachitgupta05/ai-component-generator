...
- And give the whole code in a single HTML file.
    ...
    setCode(codeMatch ? codeMatch[1].trim() : text);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 lg:px-16">
        ...
        <div className="w-full py-6 rounded-xl bg-[#141319] mt-5 p-5">
          ...
          <div className="flex items-center justify-between mt-3">
            ...
            <button
              onClick={getResponse}
              className="flex items-center p-3 rounded-lg border-0 bg-linear-to-r from-purple-400 to-purple-600 px-5 gap-2 transition-all hover:opacity-80 hover:scale-105 active:scale-95"
            >
        ...
        <div className="relative mt-2 w-full h-[80vh] bg-[#141319] rounded-xl overflow-hidden">
          {
            !outputScreen ? (
              <div className="w-full h-full flex items-center flex-col justify-center">
                <div className="p-5 w-[70px] flex items-center justify-center text-[30px] h-[70px] rounded-full bg-linear-to-r from-purple-400 to-purple-600">
                  <HiOutlineCode />
                </div>
